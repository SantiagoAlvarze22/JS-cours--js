...
const account1 = {
  ...
  movementsDates: [
    ...
    '2020-11-13T17:01:17.194Z',
    '2020-11-11T23:36:17.929Z',
    '2020-11-16T10:51:36.790Z',
  ],
  currency: 'EUR',
  locale: 'pt-PT', // de-DE
};
...
const displayMovements = function (acc, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    //is going to be at the same position bc I am using the index
...
// console.log(+'23'); //convert to a number, bc js maks type coercion

// //parsing a number from a string

// console.log(Number.parseInt('30px', 10)); //the string should dstart with a number
// console.log(Number.parseFloat('2.5rem'));
// console.log(Number.parseInt('2.5rem')); //JUST TAKE THE INTEGER PART
...
// //another way with integer, if something is a number
...
// console.log(Math.min(5, 18, 11, 2));
...
// //rounding integers
// console.log(Math.ceil(23.3)); //va hacia el entero mayor cercano
// console.log(Math.floor(23.3)); //va hacia el entero menor cercano

// console.log(Math.round(23.9));

// //floor and trunc do the same when they're dealing with postive numbers
...
const days1 = calcDaysPassed(
  new Date(2037, 10, 15, 23),
  new Date(2037, 3, 24, 23)
);
console.log(days1);
