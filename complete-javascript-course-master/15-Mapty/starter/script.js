...
//implementing the geolocatin, getCurrentPosition has two callback, the first one is the success if the map get the coordinates of the current postion and the other one is the one that is called if happened an error
...
class Running extends Workout {
  ...
  constructor(coords, distance, duration, cadence) {
    ...
    this.calcPace(); //to immediately calculate the pace
...
class App {
  ...
  _getPosition() {
    if (navigator.geolocation)
      navigator.geolocation.getCurrentPosition(
        //this keyword is bind to the current object bc is called as a regular function
  ...
  _newWorkout(e) {
    ...
    //display marker
    // console.log(lat, lng);
    //Mark with the pin the selected position
  ...
  _moveToPopup(e) {
    ...
    //moving to the correct marker meanwhile I click in the workouts objects
